...
export default function Blog() {
  return (
    <div className='flex flex-col-reverse items-center justify-center lg:block'>
      ...
      >
        <g transform='translate(.300656 75.451614)'>
          ...
          <path
            ...
            stroke-miterlimit='10'
          />
          <g transform='translate(0 0.003025)' clip-path='url(#ejQcAnIEep727)'>
            <g>
              <path
      ...
      <div className='hover:scale-110 transition-all duration-300 cursor-pointer lg:absolute bg-gradient-to-r from-slate-800 to-slate-700 w-fit px-5 py-2 m-3 border-2 border-slate-800 rounded-lg shadow-lg hover:shadow-xl'>
        <h2 className='font-bold text-3xl text-transparent bg-clip-text bg-gradient-to-r from-cyan-300 to-blue-300'>
          Blog
        </h2>
      </div>
    </div>
