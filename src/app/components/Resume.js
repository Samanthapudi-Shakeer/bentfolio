...
export default function Resume() {
  return (
    <div className='flex flex-col-reverse items-center justify-center lg:block'>
      ...
      <div className='cursor-pointer hover:scale-110 transition-all duration-300 lg:absolute bg-gradient-to-r from-slate-800 to-slate-700 w-fit px-5 py-2 m-3 border-2 border-slate-800 rounded-lg shadow-lg hover:shadow-xl'>
        <h2 className='font-bold text-3xl text-transparent bg-clip-text bg-gradient-to-r from-emerald-300 to-teal-300'>
          Resume
        </h2>
      </div>
    </div>
